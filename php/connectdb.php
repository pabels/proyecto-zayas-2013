...
if(isset($_POST['nombre']) && $_POST['nombre']!="" && isset($_POST['password']) && isset($_POST['email'])){
    ...
    else echo 'Escribe un correo valido.<br><a href=registro.php>Volver</a>';
}
else echo 'Rellena todos los campos con * <br><a href=registro.php>Volver</a>';
